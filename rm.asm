...
main(int argc, char *argv[])
{
  ...
  40:	ff 33                	pushl  (%ebx)
  42:	e8 43 02 00 00       	call   28a <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 33e:	f7 f1                	div    %ecx
 340:	0f b6 92 d8 06 00 00 	movzbl 0x6d8(%edx),%edx
...
putc(int fd, char c)
{
 ...
 46a:	85 db                	test   %ebx,%ebx
          s = "(null)";
 46c:	b8 d1 06 00 00       	mov    $0x6d1,%eax
...
free(void *ap)
{
 ...
 566:	a1 34 09 00 00       	mov    0x934,%eax
...
free(void *ap)
{
 ...
 5b8:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ba:	a3 34 09 00 00       	mov    %eax,0x934
}
...
malloc(uint nbytes)
{
 ...
 5de:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5e1:	8b 15 34 09 00 00    	mov    0x934,%edx
 ...
 606:	00 00 00 
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 609:	ba 38 09 00 00       	mov    $0x938,%edx
    base.s.size = 0;
  }
 ...
 629:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 62c:	89 15 34 09 00 00    	mov    %edx,0x934
      return (void*)(p + 1);
 ...
 64c:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 64e:	39 05 34 09 00 00    	cmp    %eax,0x934
 ...
 671:	e8 e4 fe ff ff       	call   55a <free>
  return freep;
 676:	8b 15 34 09 00 00    	mov    0x934,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
